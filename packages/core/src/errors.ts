...
export const ErrorCodes = {
  ...
  REPEATER_MAX_DEPTH: 'REPEATER_MAX_DEPTH',
  REPEATER_MAX_ITEMS: 'REPEATER_MAX_ITEMS',
  REPEATER_INVALID_ITEM: 'REPEATER_INVALID_ITEM',
  REPEATER_NO_FIELDS: 'REPEATER_NO_FIELDS',
